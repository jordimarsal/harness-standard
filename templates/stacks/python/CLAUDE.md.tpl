...
## Stack: Python
- **Version:** Python 3.9+
- **Testing:** `python3 -m unittest discover -s tests -v` or `pytest`
- **Key conventions:**
  - PEP 8 style, max 100 character lines.
  - f-strings for interpolation.
  - Double quotes `"..."` always.
  - snake_case for functions/variables, PascalCase for classes.
  - One test file per module: `tests/test_<module>.py`.
  - Use `tempfile.TemporaryDirectory()` for test isolation, not filesystem mocks.
